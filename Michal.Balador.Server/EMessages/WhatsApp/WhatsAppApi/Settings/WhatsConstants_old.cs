...
namespace WhatsAppApi.Settings
{
    ...
    public class WhatsConstants
    {
        ...
        public const string Device = "S40";//"S40-2.12.60";//"S40";
        /// <summary>
        /// The useragent used for http requests
        /// </summary>
        public const string UserAgent = "WhatsApp/2.13.21 S40Version/14.26 Device/Nokia302";// "WhatsApp/2.12.60 S40Version/14.26 Device/Nokia302" ;//"WhatsApp/2.13.21 S40Version/14.26 Device/Nokia302";
