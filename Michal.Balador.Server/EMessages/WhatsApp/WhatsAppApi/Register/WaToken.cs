...
namespace WhatsAppApi.Register
{
    class WaToken
    {
        ...
        public static string GenerateTokenNokia(string number)
        {
            ...
            var classesMd5 = "PdA2DJyKoUrwLw1Bg6EIhzh502dF9noR9uFCllGk";
        ...
        public static string GenerateTokenAndroid(string number)
        {
            ...
            // var classesMd5 = "1naz8gL5pIYWbtaOZ3207g=="; // 2.17.16
            //  Version: 2.17.242
           // var classesMd5 = "ziYneeSZm5qExsEFX/AoMQ==";
            var key2 = Base64Decode("eQV5aq/Cg63Gsq1sshN9T3gh+UUp0wIw0xgHYT1bnCjEqOJQKCRrWxdAe2yvsDeCJL+Y4G3PRD2HUF7oUgiGo8vGlNJOaux26k+A2F3hj8A=", Encoding.GetEncoding(28591));

            //https://github.com/tgalal/yowsup/issues/2350

            //  Version:2.17.426
            var classesMd5 = "OyTf9XK7xoJkKIxLgY6/Lw==";
        ...
        public static string GenerateTokenAndroidOld(string number)
        {
            var signature = "";
            //var classesMd5 = "7UDPOXwpiLBvEjT8uNwsuA=="; // 2.12.440
            var classesMd5 = "ry9Xz6kVioQctwA3G9z62Q=="; // 2.12.556
