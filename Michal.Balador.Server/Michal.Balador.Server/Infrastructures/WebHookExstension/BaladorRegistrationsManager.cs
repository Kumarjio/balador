...
//    /// a given user.
//    /// </summary>
//    public class BaladorRegistrationsManager : IWebHookRegistrationsManager
//    {
...
//        public BaladorRegistrationsManager(IWebHookManager manager, IWebHookStore store, IWebHookFilterManager filterManager, IWebHookUser userManager)
//        {
//            if (manager == null)
//            {
...
//                {
//                    webHook.Filters.Add(filter.Key);
//                }
...
//                string msg = string.Format(CultureInfo.CurrentCulture, BaladorResource.RegistrationsManager_InvalidFilters, invalidFiltersMsg);
